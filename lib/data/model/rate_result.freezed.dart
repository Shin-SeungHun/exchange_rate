...
RateResult _$RateResultFromJson(Map<String, dynamic> json) {
  return _RateResult.fromJson(json);
}
...
/// @nodoc
@JsonSerializable()
class _$RateResultImpl implements _RateResult {
  ...
  factory _$RateResultImpl.fromJson(Map<String, dynamic> json) =>
      _$$RateResultImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RateResult(lastUpdateTime: $lastUpdateTime, nextUpdateTime: $nextUpdateTime, baseCode: $baseCode, rates: $rates)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, lastUpdateTime, nextUpdateTime,
      baseCode, const DeepCollectionEquality().hash(_rates));
...
abstract class _RateResult implements RateResult {
  ...
  factory _RateResult.fromJson(Map<String, dynamic> json) =
      _$RateResultImpl.fromJson;
